...
1. The [Project Proposal](#the-project-proposal) for which you will submit to [Canvas](https://canvas.case.edu/) an initial draft for my review, and then a second draft responding to my review and providing more details, according to the deadlines in the [Course Calendar](calendar.qmd). With the second draft, you'll also produce a revision of some slides I've sent to you so you can present your draft plan in class. Shortly after the second draft is due, you will also need to complete [this scheduling form](https://bit.ly/500-project-schedule-2025) for the projects.
...
## NEW Requirement for Second Draft

- Along with the other materials you will submit by Thursday February 27 at 9 AM to Canvas regarding the second draft of your Project Proposal, I am adding something. 
- As I mentioned, I want you to give a short (2-3 minute) presentation of your second draft.
- To aid in this, I have prepared a set of 3-4 slides for each of you, which are now available (.qmd and .html files) on our Shared Drive in the Project Proposal Presentation Slides (First Drafts by TEL) folder. 
    - There is a separate document there for each you. 
    - Your job is to download the qmd version of that document I've set up for you, then edit it, as appropriate, to include your covariates, respond to any requests in the document, and then upload the resulting qmd file (now with a filename indicating this is draft2, instead of draft1) to Canvas by the same deadline of Thursday February 27 at 9 AM.
    - I will then grab those slides, and show them on screen as you give your presentation in class on February 27 at 10 AM. 
...
Note that after we have discussed the second drafts on 2025-02-27, I will ask you to [complete this form](https://bit.ly/500-project-schedule-2025) related to scheduling the presentations. The form will become available on 2025-02-28, and will be due in early March.
...
The Project Update is to be submitted to [Canvas](https://canvas.case.edu/) by the deadline in late March specified in the [Course Calendar](calendar.qmd).
